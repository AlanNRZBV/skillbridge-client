...
const PricingCard: FC<Props> = ({
  ...
  return (
    <div className="flex flex-grow flex-col gap-y-[1.875em] rounded-xl border border-light-95 bg-light-99 px-5 pb-5 pt-[1.875em] xl:px-6 xl:pb-6 xl:pt-10 2xl:gap-y-[3.125em] 2xl:px-[1.875em] 2xl:pb-[1.875em] 2xl:pt-[3.125em]">
      <span className="rounded-s border border-primary-90 bg-primary-97 px-[1.375em] py-2 text-center text-base font-medium capitalize text-dark-15 xl:px-[1.375em] xl:py-[.625em] xl:text-lg 2xl:py-3">
      ...
      <div className="flex flex-grow flex-col">
        <div className="flex flex-col gap-y-5 rounded-t-[10px] border border-light-95 bg-white p-5 xl:gap-y-6 xl:p-[1.875em] 2xl:gap-y-[1.875em] 2xl:rounded-t-[14px] 2xl:p-10">
          <span className="text-center text-lg font-medium capitalize text-dark-15">
            available features
          </span>
          <ul className="flex flex-col gap-y-5 xl:px-[1.875em]">
            {array.map((item, index) => (
              <li
                key={index}
                className="flex items-center gap-x-2 rounded-md border border-light-95 p-3 text-sm leading-[150%] text-dark-30 2xl:gap-x-3 2xl:rounded-lg 2xl:text-lg"
              >
                {item.value ? (
